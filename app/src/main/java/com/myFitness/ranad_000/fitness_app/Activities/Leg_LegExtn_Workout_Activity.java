...
public class Leg_LegExtn_Workout_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leg_extn__workout_);
        ...
        image1.setImageResource(R.drawable.leg_extension1);
        image2.setImageResource(R.drawable.leg_extension2);
