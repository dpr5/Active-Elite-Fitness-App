...
public class Leg_LegPress_Workout_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leg_press__workout_);
        ...
        image1.setImageResource(R.drawable.leg_press1);
        image2.setImageResource(R.drawable.leg_press2);
